# Copyright (C) 2016-2021 Jurriaan Bremer.
...
class KB(Dependency):
    ...
    exes = [
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2729094-v2-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2729094-v2-x86.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2731771-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2731771-x86.msu",
            ],
        ...
        },
        {
            ...
            "target": "win7x64",
            "urls": [
                "https://hatching.dev/hatchvm/Windows6.1-KB2533623-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2670838-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2670838-x86.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2786081-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2786081-x86.msu",
            ],
        ...
        },
        {
            ...
            "target": "win7x64",
            "urls": [
                "https://hatching.dev/hatchvm/Windows6.1-KB2639308-x64.msu",
            ],
        ...
        },
        {
            ...
            "target": "win7x86",
            "urls": [
                "https://hatching.dev/hatchvm/Windows6.1-KB2639308-x86.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2834140-v2-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2834140-v2-x86.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2882822-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2882822-x86.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2888049-x64.msu",
            ],
        ...
        },
        {
            ...
            "urls": [
                ...
                "https://hatching.dev/hatchvm/Windows6.1-KB2888049-x86.msu",
            ],
        ...
        },
        {
            "version": "2819745",
            "target": "win7x64",
            "url": "https://hatching.dev/hatchvm/Windows6.1-KB2819745-x64-MultiPkg.msu",
            "sha1": "5d40d059b9ea7f1d596f608a07cca49e4537dc15",
        },
        {
            "version": "2819745",
            "target": "win7x86",
            "url": "https://hatching.dev/hatchvm/Windows6.1-KB2819745-x86-MultiPkg.msu",
            "sha1": "378bd9f96b8c898b86bb0c0b92f2c9c000748c5e",
        },
        {
            "version": "3109118",
            "target": "win7x64",
            "url": "https://hatching.dev/hatchvm/Windows6.1-KB3109118-v4-x64.msu",
            "sha1": "ae0cac3e0571874dbc963dabbfa7d17d45db582c",
        },
        {
            "version": "3109118",
            "target": "win7x86",
            "url": "https://hatching.dev/hatchvm/Windows6.1-KB3109118-v4-x86.msu",
            "sha1": "378bd9f96b8c898b86bb0c0b92f2c9c000748c5e",
        },
    ]
    multiversion = True
    exit_codes = {
        ...
        2149842967: "Update not applicable for this computer",
        1058: "wuauserv service is disabled.",
    }

    success_exits = (0, 3010, 2359302)

    def _update_installed(self):
        res = self.run_powershell_command(f"Get-HotFix -Id KB{self.version}")
    ...
    def run(self):
        ...
        time.sleep(1)
        try:
            res = self.a.execute("wusa.exe C:\\setup.msu /quiet /norestart")
            exit_code = res.get("exit_code")
            if exit_code not in self.success_exits:
                known_error = self.exit_codes.get(exit_code)
                if known_error:
                    raise DependencyError(
                        f"Failed to install update KB{self.version}. "
                        f"Wusa.exe exited with non-zero exit code: "
                        f"{exit_code}. {known_error}"
                    )

                log.warning(
                    f"Unexpected exit code: {exit_code}. Checking if update "
                    f"is installed"
                )
