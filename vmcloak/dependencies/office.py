...
class Office(Dependency):
    ...
    def run(self):
        ...
        self.a.execute(
            ...
            "/v ShownFirstRunOptin /t REG_DWORD /d 1 /f" % officever[self.version]
        )
        ...
        self.a.execute(
            ...
            "/v DisableReporting /t REG_DWORD /d 1 /f" % officever[self.version]
        )
        ...
        self.a.execute(
            ...
            "/v UseOnlineContent /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Common\\Internet" '
            "/v UseOnlineAppDetect /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Common\\Internet" '
            "/v IDN_AlertOff /t REG_DWORD /d 1 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Common\\Research\\Options" '
            "/v NoDiscovery /t REG_DWORD /d 1 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Common\\Research\\Options" '
            "/v DiscoveryNeedOptIn /t REG_DWORD /d 1 /f" % officever[self.version]
        )
        # dont use online dictionaries
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Common\\Research\\Translation" '
            "/v UseOnline /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Common" '
            "/v UpdateReliabilityData /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        ...
        for product in ["Excel", "Powerpoint", "Word"]:
            ...
            self.a.execute(
                ...
                "/v EnableDEP /t REG_DWORD /d 0 /f" % (officever[self.version], product)
            )
            self.a.execute(
                'REG ADD "HKEY_CURRENT_USER\\Software\\'
                'Microsoft\\Office\\%s\\%s\\Security" '
        ...
        self.a.execute(
            ...
            "/v OpenInProtectedView /t REG_DWORD /d 2 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v Word2Files /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v Word60Files /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v Word95Files /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        ...
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v XL2Macros /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v XL2Worksheets /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v XL3Macros /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v XL3Worksheets /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v XL4Macros /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v XL4Workbooks /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Word\\Security\\FileBlock" '
            "/v XL4Worksheets /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        ...
        self.a.execute(
            ...
            "/v DataConnectionWarnings /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        ...
        self.a.execute(
            'REG ADD "HKEY_CURRENT_USER\\Software\\'
            'Microsoft\\Office\\%s\\Excel\\Security" '
            "/v WorkbookLinkWarnings /t REG_DWORD /d 0 /f" % officever[self.version]
        )
        ...
        self.a.execute(
            ...
            "/v Level /t REG_DWORD /d 1 /f" % officever[self.version]
        )
        ...
        self.a.execute(
            ...
            "/v ObjectModelGuard /t REG_DWORD /d 2 /f" % officever[self.version]
        )
